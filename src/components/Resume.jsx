  ...
  return (
    <div className="max-w-[64rem] mx-auto px-[8%] pt-16 pb-20 text-ink max-nav:px-[6%] max-nav:pt-12 max-nav:pb-16">
      <header className="mb-14 max-nav:mb-10 animate-rise motion-reduce:animate-none">
        <h1 className="text-[1.5rem] font-semibold" title="Resume">Resume</h1>
        <p className="mt-2 text-[0.95rem] text-muted">Volodymyr Korol — Frontend Team Lead, Full-stack Developer</p>
      </header>
      ...
      <section className={`${sectionClass} mb-0`} style={{ animationDelay: "0.5s" }}>
        <SectionLabel title="GitHub Activity" />
